...
//          assert(offset1 <= offset2);
      ...
      for ( int i = 0; i < iMax; i++ ) {
        ...
        while (1) {
          ...
          if (debug) {
            cout << "next coord " << topC << endl;
          }
          
          if (topC == ct2) {
            // At the end of a specific hull segment
            
            if (debug) {
              cout << "end of hull segment at coord " << topC << endl;
            }
