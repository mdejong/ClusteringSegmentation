...
void SuperpixelImage::mergeAlikeSuperpixels(Mat &inputImg)
{
  const bool debug = false;
...
int SuperpixelImage::mergeBredthFirstRecursive(Mat &inputImg, int colorspace, int startStep, vector<int32_t> *largeSuperpixelsPtr, int numBins)
{
  const bool debug = false;
...
int SuperpixelImage::mergeBackprojectSmallestSuperpixels(Mat &inputImg, int colorspace, int startStep, BackprojectRange range)
{
  const bool debug = false;
  const bool dumpEachMergeStepImage = false;
...
int SuperpixelImage::fillMergeBackprojectSuperpixels(Mat &inputImg, int colorspace, int startStep)
{
  const bool debug = false;
  const bool dumpEachMergeStepImage = false;
...
void SuperpixelImage::recurseTouchingSuperpixels(int32_t rootUID,
                                                 int32_t rootValue,
